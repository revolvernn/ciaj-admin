...
public class ExceptionHandle {
     ...
     * 处理自定义异常
     */
    @OperationLog(operation = "系统-异常",content ="处理自定义异常")
    ...
    @OperationLog(operation = "系统-异常",content ="数据库中已存在该记录")
    ...
    @OperationLog(operation = "系统-异常",content ="没有权限，请联系管理员授权")
    ...
    @OperationLog(operation = "系统-异常",content ="系统异常")
