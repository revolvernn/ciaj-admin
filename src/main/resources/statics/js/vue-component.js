...
let myTableT = Vue.extend({
    ...
    template: [
        ...
        '<el-table-column v-if="item.buttons" :align="item.align?item.align:\'center\'" :prop="item.name" :label="item.label" :key="item.name" :formatter="item.formatter" :width="item.width" :fixed="item.fixed">',
        ...
        '</template>',
        '</el-table-column>',
        '<el-table-column v-else-if="item.dict" :align="item.align?item.align:\'center\'" :prop="item.name" :label="item.label" :key="item.name" :formatter="item.formatter" :width="item.width"  :fixed="item.fixed">',
        '<template slot-scope="scope"> {{getDictLabel(item.dict, scope.row, item.name)}}</template>',
        '</el-table-column>',
        '<el-table-column v-else-if="item.cny" :align="item.align?item.align:\'center\'" :prop="item.name" :label="item.label" :key="item.name" :formatter="item.formatter" :width="item.width"  :fixed="item.fixed">',
        '<template slot-scope="scope"> {{getCny(scope.row, item.name, item.cny, item.locales)}}</template>',
        '</el-table-column>',
        '<el-table-column v-else-if="item.html" :align="item.align?item.align:\'center\'" :prop="item.name" :label="item.label" :key="item.name" :formatter="item.formatter" :width="item.width"  :fixed="item.fixed">',
        '<template slot-scope="scope">',
        '<div v-if="item.html" v-html="item.html(scope.row)"></div>',
        '</template>',
        '</el-table-column>',
        '<el-table-column v-else-if="item.image" :align="item.align?item.align:\'center\'" :prop="item.name" :label="item.label" :key="item.name" :formatter="item.formatter" :width="item.width">',
        '<template slot-scope="scope">',
        '<div v-if="item.image" v-html="getImage(scope.row,item.name)"></div>',
        '</template>',
        '</el-table-column>',
        '<el-table-column v-else-if="item.icon" :align="item.align?item.align:\'center\'" :prop="item.name" :label="item.label" :key="item.name" :formatter="item.formatter" :width="item.width">',
        '<template slot-scope="scope">',
        '<div v-if="item.icon" v-html="getIcon(scope.row,item.name)"></div>',
        '</template>',
        '</el-table-column>',
        '<el-table-column v-else-if="item.date" :align="item.align?item.align:\'center\'" :prop="item.name" :label="item.label" :key="item.name" :formatter="item.formatter" :width="item.width" :sort-by="item.sortBy" :sortable="item.sortable?item.sortable:false">',
        '<template slot-scope="scope"> {{getDateFormat(scope.row,item.name,item.date)}}</template>',
        '</el-table-column>',
        '<el-table-column v-else-if="item.msfmt" :align="item.align?item.align:\'center\'" :prop="item.name" :label="item.label" :key="item.name" :formatter="item.formatter" :width="item.width" :sort-by="item.sortBy" :sortable="item.sortable?item.sortable:false">',
        '<template slot-scope="scope"> {{getMsFmt(scope.row,item.name)}}</template>',
        '</el-table-column>',
        '<el-table-column show-overflow-tooltip v-else :align="item.align?item.align:\'center\'" :prop="item.name" :label="item.label" :key="item.name" :formatter="item.formatter" :width="item.width" :fixed="item.fixed" :sort-by="item.sortBy" :sortable="item.sortable?item.sortable:false">',
        '</el-table-column>',
        '</template>',
        '</el-table>',
